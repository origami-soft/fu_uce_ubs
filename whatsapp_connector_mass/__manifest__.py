...
{
    'name': 'WhatsApp Marketing & Group with Templates. ChatRoom',
    'summary': 'Send mass WhatsApp with Templates message Marketing. apichat.io. Chat-Api. ChatApi. Marketing whatsapp group ChatRoom 2.0.',
    ...
    'price': 100,
    'currency': 'USD',
    'images': ['static/description/Banner_mass_v6.gif'],
