...
# =====================================================================================
{
    'name': 'Real WhatsApp Chat Bot professional',
    'summary': 'BOT WhatsApp Automatic messages for product and free text. Templates and Python code. WhatsApp chat Bot integration. ChatBot WhatsApp bot ChatRoom 2.0.',
    'description': 'BOT WhatsApp Automatic messages for product and free text. Templates and Python code. WhatsApp chat Bot integration. ChatBot WhatsApp bot ChatRoom 2.0.',
    'version': '15.1.3',
    'author': 'AcruxLab',
    ...
    'price': 149.0,
    'currency': 'USD',
    'images': ['static/description/Banner_bot_v6.gif'],
