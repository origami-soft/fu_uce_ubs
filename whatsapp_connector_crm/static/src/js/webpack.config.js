...
const path_module = '../../../../../whatsapp_app/whatsapp_connector_crm/';
...
<odoo>
    <template id="assets_backend" name="acrux chat crm assets" inherit_id="web.assets_backend">
        <xpath expr="." position="inside">
            <script type="text/javascript" src="/whatsapp_connector_crm/static/src/js/app.js" />
        </xpath>
    </template>
</odoo>
`;
